...
defmodule Cog.Mixfile do
  ...
  defp deps do
    [
      # Operable Code
      ########################################################################
      {:adz, github: "operable/adz", branch: "release_testing/chris/v0.14.1"},
      {:conduit, github: "operable/conduit", branch: "release_testing/chris/v0.14.1"},
      {:fumanchu, github: "operable/fumanchu"},
      {:greenbar, github: "operable/greenbar", branch: "release_testing/chris/v0.14.1"},
      {:probe, github: "operable/probe", branch: "release_testing/chris/v0.14.1"},
      {:spanner, github: "operable/spanner", branch: "release_testing/chris/v0.14.1"},
